...
public class WallpaperFragment extends SherlockFragment {
	...
	public View onCreateView (LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		this.mView = inflater.inflate(R.layout.wallpaper_fragment_full, container, false);
		return this.mView;
	}
	...
	public void exportImage () {
		...
		try {
			...
			super.getActivity().sendBroadcast(new Intent(Intent.ACTION_MEDIA_SCANNER_SCAN_FILE, Uri.parse("file://" + dir.toString())));
